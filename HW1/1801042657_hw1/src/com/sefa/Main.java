...
public class Main {
    ...
    public static void driverMode() {
        ...
        Building build5 = new Office(48, 8, 9, "detective", "faruk"); // front
        Building build6 = new Market(58, 8, 9, "a101", 9, 21); // front
        Building build7 = new House(53, 10, 14, 5, "orange", "muzaffer"); // back
        Playground playground1 = new Playground(0, 4); // front
        Playground playground2 = new Playground(35, 4); // back

        Building build8 = new Office(3, 12, 18, "dentist", "necmi"); // front
        Building build9 = new Market(-10, 5, 14, "bakkal mito", 7, 22); // front
        Building build10 = new House(82, 14, 10, 3, "lime", "robo"); // front
        Playground playground3 = new Playground(55, 9); // back
        Playground playground4 = new Playground(135, 20); // back
        ...
        myStreet.addBuilding(1, build5);
        myStreet.addBuilding(1, build6);
        System.out.println("Adding playground to the front of street");
        myStreet.addBuilding(1, playground1); // sideChoice, playground
        System.out.println("-----------------------------");
        System.out.println("-----------------------------");
        ...
        myStreet.addBuilding(2, build7);
        myStreet.addBuilding(2, build10);
        System.out.println("Adding playground to the back of street");
        myStreet.addBuilding(2, playground2); // sideChoice, playground
        System.out.println("-----------------------------");
        System.out.println("-----------------------------");
        ...
        myStreet.addBuilding(1, build8); // sideChoice, building
        myStreet.addBuilding(2, playground3);
        System.out.println("-----------------------------");
        System.out.println("-----------------------------");
        ...
        try {
            ...
            System.out.println(build9);
            System.out.println(playground4);
            myStreet.addBuilding(1, build9); // sideChoice, building
            myStreet.addBuilding(2, playground4);
        } catch (ArrayIndexOutOfBoundsException e) {
            e.printStackTrace();
        } catch (NegativeArraySizeException e) {
            e.printStackTrace();
        ...
        System.out.println("Deleting from the street (correct input - position = 82)");
        myStreet.deleteBuilding(2, 82); // sideChoice, position
        System.out.println("-----------------------------");
        System.out.println("-----------------------------");
