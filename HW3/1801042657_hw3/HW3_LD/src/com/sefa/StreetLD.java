 ...
 */
public class StreetLD implements City {
    private int streetLength;

    private LDLinkedList frontStreet = new LDLinkedList();
    private LDLinkedList backStreet = new LDLinkedList();
     ...
     */
    private boolean checkEnoughLand(LDLinkedList streetArray, Object build) {
     ...
     * @param build       the building
     */
    private void constructBuilding(LDLinkedList streetArray, Object build) {
     ...
     * @return boolean
     */
    private boolean checkDeletion(LDLinkedList streetArray, Object build) {
